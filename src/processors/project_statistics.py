...
def main():
    ...
    try:
        ...
        summary = f"Generated project statistics with {len(hours_pivot)} categories, {total_hours:.1f} total hours, {total_volunteers} volunteers, and {len(projects_pivot_adjusted)} unique projects. Excel report ready for PowerPoint integration."
